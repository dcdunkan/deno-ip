...
describe("IP library for node.js", () => {
  describe("toBuffer()/toString() methods", () => {
    ...
    it("should convert to buffer IPv6 address", () => {
      ...
      assert_(/(00){15,15}01/.test(buf.toString("hex")));
    ...
    it("should convert to buffer IPv6 address in-place", () => {
      ...
      assert_(/(00){15,15}01/.test(buf.toString("hex", offset, offset + 16)));
  ...
  describe("isEqual() method", () => {
    it("should check if addresses are equal", () => {
      assert_(ip.isEqual("127.0.0.1", "::7f00:1"));
      assert_(!ip.isEqual("127.0.0.1", "::7f00:2"));
      assert_(ip.isEqual("127.0.0.1", "::ffff:7f00:1"));
      assert_(!ip.isEqual("127.0.0.1", "::ffaf:7f00:1"));
      assert_(ip.isEqual("::ffff:127.0.0.1", "::ffff:127.0.0.1"));
      assert_(ip.isEqual("::ffff:127.0.0.1", "127.0.0.1"));
    });
  });
